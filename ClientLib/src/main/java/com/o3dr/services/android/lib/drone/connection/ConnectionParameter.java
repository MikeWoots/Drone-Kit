...
public class ConnectionParameter implements Parcelable {
    ...
    public static ConnectionParameter newAoaConnection(@Nullable Uri tlogLoggingUri){
        return newAoaConnection(tlogLoggingUri, DEFAULT_EVENTS_DISPATCHING_PERIOD);
    }

    public static ConnectionParameter newAoaConnection(@Nullable Uri tlogLoggingUri,
                                                        long eventsDispatchingPeriod){
        Bundle paramsBundle = new Bundle(1);
        return new ConnectionParameter(ConnectionType.TYPE_AOA, paramsBundle, tlogLoggingUri, eventsDispatchingPeriod);
    }
