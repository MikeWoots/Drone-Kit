...
public class SurveyImpl extends MissionItemImpl {
    ...
    public void update(double angle, double altitude, double overlap, double sidelap, double speed,
        ...
        surveyData.update(angle, altitude, overlap, sidelap, speed, lockOrientation, saveable, sunny);
    }
    ...
    public void build() throws Exception {
        ...
        grid = null;
        GridBuilder gridBuilder = new GridBuilder(polygon, surveyData, polygon.getPoints().get(0));
