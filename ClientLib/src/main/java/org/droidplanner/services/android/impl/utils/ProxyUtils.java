    ...
    public static MissionItemImpl getMissionItemImpl(MissionImpl missionImpl, MissionItem proxyItem) {
        ...
        switch (proxyItem.getType()) {
            ...
            case SURVEY: {
                ...
                SurveyImpl temp = new SurveyImpl(missionImpl, proxy.getPolygonPoints(), proxy.getPolygonPointAltitudes());
                ...
                if (surveyDetail != null) {
                    ...
                    temp.update(surveyDetail.getAngle(), (surveyDetail.getAltitude()),
                            ...
                            surveyDetail.getSpeed(), surveyDetail.getLockOrientation(),
                            surveyDetail.isSaveable(), surveyDetail.isSunny());
                }
            ...
            case SPLINE_SURVEY: {
                ...
                SplineSurveyImpl temp = new SplineSurveyImpl(missionImpl, proxy.getPolygonPoints(), proxy.getPolygonPointAltitudes());
                temp.setStartCameraBeforeFirstWaypoint(proxy.isStartCameraBeforeFirstWaypoint());
    ...
    public static MissionItem getProxyMissionItem(MissionItemImpl itemImpl) {
        ...
        switch (itemImpl.getType()) {
            ...
            case SURVEY: {
                ...
                temp.setPolygonPointAltitudes((source.getPolygonAltitudes()));
