    ...
    public void onBtnConnectTap(View view) {
        if (this.drone.isConnected()) {
            ...
            if (selectedConnectionType == ConnectionType.TYPE_USB)
                connectionParams = ConnectionParameter.newUsbConnection(null);
            else if (selectedConnectionType == 2)
                connectionParams = ConnectionParameter.newAoaConnection(null);
            else connectionParams = ConnectionParameter.newUdpConnection(null);
